...
- Core: Support kernel.bin ability sections beyond the vanilla 116 abilities (up to 128), and battle command and command ability data sections beyond the vanilla 39 and 12 entries
